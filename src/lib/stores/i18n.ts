...
const dict = {
  ja: {
    ...
    loadNoData: '保存データがありません',
    clearSaveSuccess: '保存データを削除しました',
    clearSaveFailed: '削除に失敗しました',
  ...
  en: {
    ...
    loadNoData: 'No saved data',
    clearSaveSuccess: 'Save data cleared',
    clearSaveFailed: 'Failed to clear',
